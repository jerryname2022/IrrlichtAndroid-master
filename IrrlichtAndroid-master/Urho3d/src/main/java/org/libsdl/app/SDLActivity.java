...
public class SDLActivity extends Activity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    if (!mIsSharedLibraryLoaded) {
      ...
      try {
        if (onLoadLibrary(libraryNames)) mIsSharedLibraryLoaded = true;
   ...
   * ready.
   * Note: Some Android variants may send multiple surfaceChanged events, so we don't need to
   * resume
  ...
  protected static class SDLCommandHandler extends Handler {
    @Override public void handleMessage(Message msg) {
      ...
      switch (msg.arg1) {
        ...
        default:
          if ((context instanceof SDLActivity) && !((SDLActivity) context).onUnhandledMessage(
              msg.arg1, msg.obj)) {
  ...
  public static native void onNativeTouch(int touchDevId, int pointerFingerId, int action, float x,
      float y, float p);
   ...
   */
  @Deprecated public InputStream openAPKExtensionInputStream(String fileName) throws IOException {
        ...
        case MotionEvent.ACTION_MOVE:
          ...
          if (joystick != null) {
            for (int i = 0; i < joystick.axes.size(); i++) {
              ...
              float value =
                  (event.getAxisValue(range.getAxis(), actionPointerIndex) - range.getMin()) / range
                      .getRange() * 2.0f - 1.0f;
