...
#include "../../include/Urho3D/ThirdParty/SDL/SDL_log.h"
...
SeparateEventsHintWatcher(void *userdata, const char *name,
    ...
    (*env)->SetStaticBooleanField(env, mActivityClass, fid,
                                  separate_mouse_and_touch ? JNI_TRUE : JNI_FALSE);
}
    ...
    switch (action) {
        case ACTION_DOWN:
            ...
            if (!separate_mouse_and_touch) {
                ...
                SDL_SendMouseButton(Android_Window, SDL_TOUCH_MOUSEID, SDL_PRESSED,
                                    SDL_BUTTON_LEFT);
            }
        ...
        case ACTION_UP:
            ...
            if (!separate_mouse_and_touch) {
                /* send mouse up */
                SDL_SendMouseButton(Android_Window, SDL_TOUCH_MOUSEID, SDL_RELEASED,
                                    SDL_BUTTON_LEFT);
            }
