...
#include "../../../.././include/Urho3D/ThirdParty/SDL/SDL_stdinc.h"
#include "../../../.././include/Urho3D/ThirdParty/SDL/SDL_assert.h"
#include "../../../.././include/Urho3D/ThirdParty/SDL/SDL_hints.h"
#include "../../../.././include/Urho3D/ThirdParty/SDL/SDL_events.h"

#ifdef __ANDROID__

#include "../../include/Urho3D/ThirdParty/SDL/SDL_system.h"
...
/* Surface Created */
JNIEXPORT void JNICALL Java_org_libsdl_app_SDLActivity_onNativeSurfaceChanged(JNIEnv *env,
                                                                              jclass jcls) {
    SDL_WindowData *data;
...
/* Surface Destroyed */
JNIEXPORT void JNICALL Java_org_libsdl_app_SDLActivity_onNativeSurfaceDestroyed(JNIEnv *env,
                                                                                jclass jcls) {
...
JNIEXPORT jstring JNICALL Java_org_libsdl_app_SDLActivity_nativeGetHint(JNIEnv *env, jclass cls,
                                                                        jstring name) {
...
char **SDL_Android_GetFileList(const char *path, int *count) {
    ...
    mid = (*mEnv)->GetMethodID(mEnv, (*mEnv)->GetObjectClass(mEnv, assetManager), "list",
