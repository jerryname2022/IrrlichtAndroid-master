...
struct btDbvt {
    ...
    static void
    extractLeaves(const btDbvtNode *node, btAlignedObjectArray<const btDbvtNode *> &leaves);
    ...
    // Helpers
    static DBVT_INLINE int
    nearest(const int *i, const btDbvt::sStkNPS *a, btScalar v, int l, int h) {
        int m = 0;
        while (l < h) {
            m = (l + h) >> 1;
...
inline void btDbvt::rayTestInternal(const btDbvtNode *root,
    ...
    if (root) {
        ...
        do {
            ...
            result1 = btRayAabb2(rayFrom, rayDirectionInverse, signs, bounds, tmin, lambda_min,
                                 lambda_max);
            if (result1) {
                if (node->isinternal()) {
                    if (depth > treshold) {
...
inline void btDbvt::rayTest(const btDbvtNode *root,
    ...
    if (root) {
        ...
        do {
            ...
            btScalar tmin = 1.f, lambda_min = 0.f;
            unsigned int result1 = btRayAabb2(rayFrom, rayDirectionInverse, signs, bounds, tmin,
...
inline void btDbvt::collideOCL(const btDbvtNode *root,
    ...
    if (root) {
        ...
        stack.push_back(allocate(ifree, stock,
        ...
        do {
            ...
            if (policy.Descent(se.node)) {
                if (se.node->isinternal()) {
                    ...
                    sStkNPS nes[] = {sStkNPS(pns[0], se.mask,
