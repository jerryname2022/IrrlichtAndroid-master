...
//		m_AR[2] = vepsi + m_R1to0[2].absolute();
    ...
    calc_from_homogenic(const btTransform &trans0, const btTransform &trans1) {
    ...
    SIMD_FORCE_INLINE void
    calc_from_full_invert(const btTransform &trans0, const btTransform &trans1) {
...
public:
    ...
    */
    ...
    SIMD_FORCE_INLINE void
    projection_interval(const btVector3 &direction, btScalar &vmin, btScalar &vmax) const {
        btVector3 center = (m_max + m_min) * 0.5f;
    ...
    overlapping_trans_conservative(const btAABB &box, btTransform &trans1_to_0) const {
        btAABB tbox = box;
